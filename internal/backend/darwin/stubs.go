...
// command set, so a line using one simply fails at run time as err, which
// is acceptable (Out of Scope: "their Backend methods exist only as
// compile-satisfying stubs in Phase 1").
